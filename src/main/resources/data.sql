...
INSERT INTO User(email,name,job) VALUES ('absc@naver.com','일이삼',PASSWORD('1234'),'JB001');
INSERT INTO User(email,name,job) VALUES ('sdfss@kakao.com','제프',PASSWORD('1234'),'JB002');
INSERT INTO User(email,name,job) VALUES ('gggg@gmail.com','고골이',PASSWORD('1234'),'JB001');
INSERT INTO User(email,name,job) VALUES ('SONss@nate.com','손오공',PASSWORD('1234'),'JB005');
